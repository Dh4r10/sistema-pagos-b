"""
Django settings for sistema_pagos_b project.
...
SECRET_KEY = 'django-insecure-gpchgoks12w1%_$x%=*t8!1b1k(lu8eqb2+69^l9-p%uy061+n'
...
ROOT_URLCONF = 'sistema_pagos_b.urls'
...
WSGI_APPLICATION = 'sistema_pagos_b.wsgi.application'
